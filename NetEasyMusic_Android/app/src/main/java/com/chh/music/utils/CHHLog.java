...
public class CHHLog {
    public static final String LOGGER_NAMESPACE = "com.chh";

    private static final String LOGTAG = "Music";
    ...
    public static void c(final String message) {
        CHHLog.c(message, null);
    }

    public static void v(final String message) {
        CHHLog.v(message, null);
    }

    public static void d(final String message) {
        CHHLog.d(message, null);
    }

    public static void i(final String message) {
        CHHLog.i(message, null);
    }

    public static void w(final String message) {
        CHHLog.w(message, null);
    }

    public static void e(final String message) {
        CHHLog.e(message, null);
    }
